...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'gradient-energy-primary': 'var(--gradient-energy-primary)',
        'gradient-energy-glow': 'var(--gradient-energy-glow)',
        'gradient-card': 'var(--gradient-card)',
        'gradient-trading': 'var(--gradient-trading)',
      },
      boxShadow: {
        'energy-glow': 'var(--shadow-energy-glow)',
